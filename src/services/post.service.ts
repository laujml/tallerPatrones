...
import { getAllPosts } from "../data/posts.store";
...
export function listPosts(
  ...
  // "trash" se trata como el estado eliminado; deleted_at es la marca dura de soft delete
  let result = getAllPosts().filter((p) => !p.deleted_at);
